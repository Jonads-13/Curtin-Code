package edu.curtin.productviewer.view;
import edu.curtin.productviewer.controller.*;
...
public class MainWindow
{
    ...
    public void show()
    {
        ...
        upGroupBtn.setOnAction(event -> upGroupHandler());
        addProductBtn.setOnAction(event -> addProductHandler());
        addProductGroupBtn.setOnAction(event -> addProductGroupHandler());
