...
import java.util.*;
 public class MethodsMenu
 {
		...
		{		
		    ...
		    {        
				...
				case 2:
						...
						//Perform calcualtion
				        answer = prod2Ints(numOne, numTwo);
	...
	public static int sum2Ints(int pNumOne, int pNumTwo)
	{
		//Perform addition calculation
	    return pNumOne + pNumTwo;
	}
	
	public static int prod2Ints(int pNumOne, int pNumTwo)
	{
		//Perform multiplication caculation
		return pNumOne * pNumTwo;
	}

	public static boolean div2Ints(int pNumOne, int pNumTwo)
	{
        //Check division possibility
		return (pNumOne%pNumTwo==0);
	}
